...
local function Settings()
    ...
    return GuildieCraftsDB.settings
end
...
function Debug:Log(msg)
    if self:IsEnabled() then
        print("|cff00ccffGuildieCrafts Debug|r " .. tostring(msg))
    end
end

function Debug:GetLogPathHint()
    local account = GetRealmName and (GetRealmName() .. "\\") or ""
    return "World of Warcraft\\_anniversary_\\Logs\\FrameXML.log (search for 'GuildieCrafts' or 'taint')"
end
...
function Debug:EnableTaintLog()
    ...
    print("|cff00ccffGuildie Crafts|r Taint debug enabled.")
    print("  1. /reload")
    print("  2. Use GuildieCrafts normally (open UI, use dropdowns, place order, etc.)")
...
function Debug:DisableTaintLog()
    ...
    print("|cff00ccffGuildie Crafts|r Taint debug disabled.")
end

function Debug:DumpState()
    print("|cff00ccffGuildie Crafts|r Taint state snapshot:")
    print("  addon execution secure: " .. (issecure() and "yes" or "NO (tainted)"))
    print("  loggingOut flag: " .. tostring(GuildieCrafts._loggingOut))
...
function Debug:SetBisect(flag, enabled)
    ...
    if flag == "reset" then
        ...
        print("|cff00ccffGuildie Crafts|r Bisect flags cleared. /reload recommended.")
        return
    end
    ...
    elseif flag == "nouspecial" then
        ...
        print("|cff00ccffGuildie Crafts|r Unknown bisect flag. Options:")
    ...
    print("|cff00ccffGuildie Crafts|r Bisect " .. flag .. " = " .. tostring(Settings()[key]))
...
function Debug:HandleCommand(msg)
    ...
    if msg == "" or msg == "help" then
        print("|cff00ccffGuildieCrafts Debug|r commands:")
