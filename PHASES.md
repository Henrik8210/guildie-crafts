...
| Tailoring | Heart of Darkness | HoD crafts — **v1.1 (live)** |
| Leatherworking | Heart of Darkness | HoD crafts — **v1.1 (live)** |
| Blacksmithing | Heart of Darkness | HoD crafts — **v1.1 (live)** |
...
2. Add gem IDs in `Gems.lua`, HoD crafts in `Materials.lua`, and profession recipe scans in `Recipes.lua`
