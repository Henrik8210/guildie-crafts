...
local Debug = {}
GuildWorkshopTest.Debug = Debug

local function Settings()
    GuildWorkshopTestDB.settings = GuildWorkshopTestDB.settings or {}
    return GuildWorkshopTestDB.settings
end
...
function Debug:Log(msg)
    if self:IsEnabled() then
        print("|cff00ccffGuildWorkshop Debug|r " .. tostring(msg))
    end
end

function Debug:GetLogPathHint()
    local account = GetRealmName and (GetRealmName() .. "\\") or ""
    return "World of Warcraft\\_anniversary_\\Logs\\FrameXML.log (search for 'GuildWorkshop' or 'taint')"
end
...
function Debug:EnableTaintLog()
    ...
    print("|cff00ccffGuildWorkshopTest|r Taint debug enabled.")
    print("  1. /reload")
    print("  2. Use GuildWorkshop normally (open UI, use dropdowns, place order, etc.)")
...
function Debug:DisableTaintLog()
    ...
    print("|cff00ccffGuildWorkshopTest|r Taint debug disabled.")
end

function Debug:DumpState()
    print("|cff00ccffGuildWorkshopTest|r Taint state snapshot:")
    print("  addon execution secure: " .. (issecure() and "yes" or "NO (tainted)"))
    print("  loggingOut flag: " .. tostring(GuildWorkshopTest._loggingOut))
...
function Debug:SetBisect(flag, enabled)
    ...
    if flag == "reset" then
        ...
        print("|cff00ccffGuildWorkshopTest|r Bisect flags cleared. /reload recommended.")
        return
    end
    ...
    elseif flag == "nouspecial" then
        ...
        print("|cff00ccffGuildWorkshopTest|r Unknown bisect flag. Options:")
    ...
    print("|cff00ccffGuildWorkshopTest|r Bisect " .. flag .. " = " .. tostring(Settings()[key]))
...
function Debug:HandleCommand(msg)
    ...
    if msg == "" or msg == "help" then
        print("|cff00ccffGuildWorkshop Debug|r commands:")
    ...
    print("|cff00ccffGuildWorkshopTest|r Unknown debug command. Try /gor debug help")
end
