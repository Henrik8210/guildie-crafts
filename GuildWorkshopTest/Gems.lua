...
GuildWorkshopTest_CutGemsCache = nil
GuildWorkshopTest_RareCutGemsCache = nil

GuildWorkshopTest_GemByName = {}
GuildWorkshopTest_GemByItemId = {}
for _, gem in ipairs(GuildWorkshopTest_Gems) do
    GuildWorkshopTest_GemByName[gem.name] = gem
    if gem.itemId then
        GuildWorkshopTest_GemByItemId[gem.itemId] = gem
    end
end

function GuildWorkshopTest_GetCutGems()
    if GuildWorkshopTest_CutGemsCache then
        return GuildWorkshopTest_CutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GuildWorkshopTest_Gems) do
    ...
    GuildWorkshopTest_CutGemsCache = list
    return list
end

function GuildWorkshopTest_GetEpicCutGems()
    return GuildWorkshopTest_GetCutGems()
end

function GuildWorkshopTest_GetRareCutGems()
    if GuildWorkshopTest_RareCutGemsCache then
        return GuildWorkshopTest_RareCutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GuildWorkshopTest_Gems) do
    ...
    GuildWorkshopTest_RareCutGemsCache = list
    return list
end

function GuildWorkshopTest_GetRawGems()
    local list = {}
    for _, gem in ipairs(GuildWorkshopTest_Gems) do
        if gem.raw then
            table.insert(list, gem)
...
function GuildWorkshopTest_GetGemColor(name)
    local gem = GuildWorkshopTest_GemByName[name]
    return gem and gem.color or "Unknown"
end

function GuildWorkshopTest_GetRecipeGems(tier)
    if tier == "rare" then
        return GuildWorkshopTest_GetRareCutGems()
    end
    return GuildWorkshopTest_GetEpicCutGems()
end

function GuildWorkshopTest_IsTrackedRecipeItemId(itemId)
    local gem = GuildWorkshopTest_GemByItemId[itemId]
    if gem and not gem.raw then
        return true
    end
    if GuildWorkshopTest_IsTrackedHoDCraftItemId then
        return GuildWorkshopTest_IsTrackedHoDCraftItemId(itemId)
    end
    return false
end

function GuildWorkshopTest_FormatGemLabel(gem)
    return gem.name
end
