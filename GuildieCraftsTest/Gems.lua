...
GuildieCraftsTest_CutGemsCache = nil
GuildieCraftsTest_RareCutGemsCache = nil

GuildieCraftsTest_GemByName = {}
GuildieCraftsTest_GemByItemId = {}
for _, gem in ipairs(GuildieCraftsTest_Gems) do
    GuildieCraftsTest_GemByName[gem.name] = gem
    if gem.itemId then
        GuildieCraftsTest_GemByItemId[gem.itemId] = gem
    end
end

function GuildieCraftsTest_GetCutGems()
    if GuildieCraftsTest_CutGemsCache then
        return GuildieCraftsTest_CutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GuildieCraftsTest_Gems) do
    ...
    GuildieCraftsTest_CutGemsCache = list
    return list
end

function GuildieCraftsTest_GetEpicCutGems()
    return GuildieCraftsTest_GetCutGems()
end

function GuildieCraftsTest_GetRareCutGems()
    if GuildieCraftsTest_RareCutGemsCache then
        return GuildieCraftsTest_RareCutGemsCache
    end
    local list = {}
    for _, gem in ipairs(GuildieCraftsTest_Gems) do
    ...
    GuildieCraftsTest_RareCutGemsCache = list
    return list
end

function GuildieCraftsTest_GetRawGems()
    local list = {}
    for _, gem in ipairs(GuildieCraftsTest_Gems) do
        if gem.raw then
            table.insert(list, gem)
...
function GuildieCraftsTest_GetGemColor(name)
    local gem = GuildieCraftsTest_GemByName[name]
    return gem and gem.color or "Unknown"
end

function GuildieCraftsTest_GetRecipeGems(tier)
    if tier == "rare" then
        return GuildieCraftsTest_GetRareCutGems()
    end
    return GuildieCraftsTest_GetEpicCutGems()
end

function GuildieCraftsTest_IsTrackedRecipeItemId(itemId)
    local gem = GuildieCraftsTest_GemByItemId[itemId]
    if gem and not gem.raw then
        return true
    end
    if GuildieCraftsTest_IsTrackedHoDCraftItemId then
        return GuildieCraftsTest_IsTrackedHoDCraftItemId(itemId)
    end
    return false
end

function GuildieCraftsTest_FormatGemLabel(gem)
    return gem.name
end
