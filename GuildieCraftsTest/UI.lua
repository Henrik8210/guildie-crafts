...
function UI:CreateMainFrame()
    ...
    f.portraitIcon = GuildieCraftsTest_GetDefaultWorkshopIcon()
...
function UI:RefreshWorkshopPanel()
    ...
    if room then
        ...
        if room.leader == player then
            role = "Leader"
        elseif GuildieCraftsTest_IsRoomCoLeader(room, player) then
            role = "Co-leader"
        end
        ...
        panel.status:SetText(string.format(
            ...
            GuildieCraftsTest_ColorizePlayer(room.leader),
            role
        ))
    else
