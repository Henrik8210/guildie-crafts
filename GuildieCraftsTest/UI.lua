...
function UI:CreateMainFrame()
    ...
    SetFramePortraitIcon(f, GuildieCraftsTest_GetDefaultWorkshopPortrait())
    ...
    local function AddGemLines(counts, indent)
        ...
        for _, entry in ipairs(listing) do
            ...
            if entry.itemId then
                ...
                GuildieCraftsTest_AttachItemTooltip(row, function(owner)
                    return owner.itemId
                end)
            end
...
function UI:RefreshRecipesPanel()
    ...
    for _, entry in ipairs(GuildieCraftsTest_GetRecipeCoverage(room, tier)) do
        if entry.craft then
            ...
            GuildieCraftsTest_AttachItemTooltip(nameBtn, function(owner)
                return owner.itemId
            end, "ANCHOR_RIGHT")
...
function UI:CreateGemIconRow(parent, order, yOffset, startX)
    ...
    for i, gemName in ipairs(order.gems or {}) do
        ...
        if itemId then
            ...
            btn.itemId = itemId
            GuildieCraftsTest_AttachItemTooltip(btn, function(owner)
                return owner.itemId
            end)
            ...
            GuildieCraftsTest_AttachItemTooltip(labelBtn, function(owner)
                return owner.itemId
            end)
